...
def casual_impact_analysis_one_pt(epi_data: pd.array, response_data: pd.array, change_points: np.array, results_out: bool = True, debug_out: bool = False, change_pt: int = 0) -> object:
...
def causal_impact_analysis(epi_data: pd.array, response_data: pd.array, all_change_pts: bool = True, results_out: bool = True, debug_out: bool = False, change_pt: int = 0) -> Tuple:
    """
    ...
    if all_change_pts:
        ...
        for i in range(len(change_points)-1):
            ci_objects.append(casual_impact_analysis_one_pt(epi_data, response_data, change_points, results_out, debug_out, i))
    else:
        ci_objects = casual_impact_analysis_one_pt(epi_data, response_data, change_points, results_out, debug_out, change_pt)
